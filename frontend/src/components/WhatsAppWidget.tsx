...
const WhatsAppWidget: React.FC<WhatsAppWidgetProps> = ({
  ...
  message = 'Hello! I am interested in your eco-friendly services.',
  className = ''
}) => {
  return (
    <div className={`fixed bottom-4 right-4 sm:bottom-6 sm:right-6 z-50 ${className}`}>
      <a
        ...
        className="group bg-green-500 hover:bg-green-600 text-white p-3 sm:p-4 rounded-full shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-110 flex items-center justify-center w-12 h-12 sm:w-14 sm:h-14"
